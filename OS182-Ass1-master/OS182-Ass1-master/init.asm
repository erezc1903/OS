...
main(void)
{
  ...
  52:	e8 a9 04 00 00       	call   500 <printf>
    pid = fork();
  57:	e8 2e 03 00 00       	call   38a <fork>
    if(pid < 0){
  ...
  70:	e8 25 03 00 00       	call   39a <wait>
  ...
  b0:	e8 15 03 00 00       	call   3ca <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 3d 04 00 00       	call   500 <printf>
      exit();
  c3:	e8 ca 02 00 00       	call   392 <exit>
main(void)
{
  int pid, wpid;
  ...
  d2:	e8 03 03 00 00       	call   3da <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 20 08 00 00       	push   $0x820
  e0:	e8 ed 02 00 00       	call   3d2 <open>
...
strncpy(char *s, const char *t, int n)
{
 ...
 130:	eb 19                	jmp    14b <strncpy+0x2b>
 132:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 138:	83 c3 01             	add    $0x1,%ebx
 13b:	0f b6 4b ff          	movzbl -0x1(%ebx),%ecx
 13f:	83 c2 01             	add    $0x1,%edx
 142:	84 c9                	test   %cl,%cl
 144:	88 4a ff             	mov    %cl,-0x1(%edx)
 147:	74 09                	je     152 <strncpy+0x32>
 149:	89 f1                	mov    %esi,%ecx
 14b:	85 c9                	test   %ecx,%ecx
 14d:	8d 71 ff             	lea    -0x1(%ecx),%esi
 150:	7f e6                	jg     138 <strncpy+0x18>
    ;
  while(n-- > 0)
 152:	31 c9                	xor    %ecx,%ecx
 154:	85 f6                	test   %esi,%esi
 156:	7e 17                	jle    16f <strncpy+0x4f>
 158:	90                   	nop
 159:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
 160:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
 164:	89 f3                	mov    %esi,%ebx
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49f:	f7 f6                	div    %esi
 4a1:	0f b6 92 78 08 00 00 	movzbl 0x878(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 70 08 00 00       	mov    $0x870,%eax
...
free(void *ap)
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 44 0b 00 00       	mov    %eax,0xb44
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 71d:	a3 44 0b 00 00       	mov    %eax,0xb44
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 44 0b 00 00    	mov    0xb44,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7df:	89 15 44 0b 00 00    	mov    %edx,0xb44
      return (void*)(p + 1);
 ...
 7f4:	eb e9                	jmp    7df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7f6:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 7fd:	0b 00 00 
 800:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 48 0b 00 00       	mov    $0xb48,%eax
 80f:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 816:	00 00 00 
