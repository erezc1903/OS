...
main(int argc, char **argv)
{
  ...
  2e:	83 c3 01             	add    $0x1,%ebx
    kill(atoi(argv[i]));
  31:	e8 5a 02 00 00       	call   290 <atoi>
  36:	89 04 24             	mov    %eax,(%esp)
  39:	e8 f4 02 00 00       	call   332 <kill>
  ...
  43:	75 e3                	jne    28 <main+0x28>
    kill(atoi(argv[i]));
  exit();
  45:	e8 b8 02 00 00       	call   302 <exit>
main(int argc, char **argv)
{
  int i;
...
putc(int fd, char c)
{
 ...
 588:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 58b:	b8 a4 07 00 00       	mov    $0x7a4,%eax
...
free(void *ap)
{
 ...
 667:	89 08                	mov    %ecx,(%eax)
  freep = p;
 669:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 66e:	5b                   	pop    %ebx
 66f:	5e                   	pop    %esi
 670:	5f                   	pop    %edi
 ...
 68a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 68d:	a3 78 0a 00 00       	mov    %eax,0xa78
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 74f:	89 15 78 0a 00 00    	mov    %edx,0xa78
      return (void*)(p + 1);
 ...
 764:	eb e9                	jmp    74f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 766:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 76d:	0a 00 00 
 770:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
 77f:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 786:	00 00 00 
