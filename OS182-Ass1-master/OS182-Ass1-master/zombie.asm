...
main(void)
{
  ...
  1d:	6a 05                	push   $0x5
  1f:	e8 3e 03 00 00       	call   362 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 a6 02 00 00       	call   2d2 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
...
strncpy(char *s, const char *t, int n)
{
  ...
  6b:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
  6e:	89 c2                	mov    %eax,%edx
  70:	eb 19                	jmp    8b <strncpy+0x2b>
  72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  78:	83 c3 01             	add    $0x1,%ebx
  7b:	0f b6 4b ff          	movzbl -0x1(%ebx),%ecx
  7f:	83 c2 01             	add    $0x1,%edx
  82:	84 c9                	test   %cl,%cl
  84:	88 4a ff             	mov    %cl,-0x1(%edx)
  87:	74 09                	je     92 <strncpy+0x32>
  89:	89 f1                	mov    %esi,%ecx
  8b:	85 c9                	test   %ecx,%ecx
  8d:	8d 71 ff             	lea    -0x1(%ecx),%esi
  90:	7f e6                	jg     78 <strncpy+0x18>
    ;
  while(n-- > 0)
  92:	31 c9                	xor    %ecx,%ecx
  94:	85 f6                	test   %esi,%esi
  96:	7e 17                	jle    af <strncpy+0x4f>
  98:	90                   	nop
  99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
  a0:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
  a4:	89 f3                	mov    %esi,%ebx
  a6:	83 c1 01             	add    $0x1,%ecx
  a9:	29 cb                	sub    %ecx,%ebx
  char *os;
...
0000037a <getVariable>:
SYSCALL(getVariable)
 37a:	b8 18 00 00 00       	mov    $0x18,%eax
 37f:	cd 40                	int    $0x40
 381:	c3                   	ret    

00000382 <remVariable>:
SYSCALL(remVariable)
