...
main(int argc, char *argv[])
{
  ...
  exit();
  4b:	e8 d2 02 00 00       	call   322 <exit>
    exit();
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 ec 07 00 00 	movzbl 0x7ec(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 e3 07 00 00       	mov    $0x7e3,%eax
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 b8 0a 00 00       	mov    %eax,0xab8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 b8 0a 00 00    	mov    %edx,0xab8
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 78d:	0a 00 00 
 790:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 bc 0a 00 00       	mov    $0xabc,%eax
 79f:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 7a6:	00 00 00 
